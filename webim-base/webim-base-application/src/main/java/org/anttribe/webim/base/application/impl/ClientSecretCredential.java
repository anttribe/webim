/*
 * 文  件   名: ClientSecretCredential.java
...
{
    private static Logger logger = LoggerFactory.getLogger(ClientSecretCredential.class);
    ...
    public Token getToken()
    {
        if (null == token || token.isExpired())
        {
            try
            {
                ...
                logger.info("Token result, statuscode:" + tokenResponse.getStatusLine().toString());
